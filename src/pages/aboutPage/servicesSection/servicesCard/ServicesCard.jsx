...
export default function ServicesCard({ id, idNum, name, description, icon, bgg }) {
    return (
        <div className="services relative ">
            <div className="services-card relative group  flex flex-col justify-start gap-[1rem] max-w-[46rex] h-auto min-h-[23.7rem] bg-[#ffffff] rounded-2xl px-[2rem] py-[5.3rem] border-[.3rem] border-[var(--bblue-color)] transform hover:translate-y-[-1em] duration-500 hover:bg-[var(--background-color)] overflow-x-hidden hover:border-[var(--bblue-color)]">
