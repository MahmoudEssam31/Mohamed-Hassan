...
export default function ContactEmail() {
  return (
      <div className="contact-email mt-[6em] w-[80%] flex flex-col gap-[1.5rem]">
          ...
          <Formik initialValues={{ name: "", email: "", message: "", }} onSubmit={[(values) => console.log(values)]}>
              <Form>
                  ...
                  <button className='w-[10rem] h-[4rem] bg-[var(--background-color)] text-[var(--main-color)] text-[1rem] font-[600] border border-[var(--bg-form)] flex justify-center items-center rounded-3xl my-[2rem] cursor-pointer hover:bg-[var(--yellow-color)] hover:text-[var(--background-color)] duration-300' type='submit'>Send Message</button>
              </Form>
          </Formik>
      </div>
  );
