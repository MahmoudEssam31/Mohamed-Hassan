...
export default function ScrollToTop() {
    ...
    return (
        <button
            ...
            className={`fixed right-1 bottom-24 z-50 p-3 rounded-full lg:w-[3.5rem] lg:h-[3.5rem] md:w-[2.5rem] md:h-[2.5rem] hidden md:flex bg-[var(--bblue-color)] shadow-lg border
