...
export default function Contacts() {
  return (
      <div className="contacts">
          ...
          <CustomContainer>
              <div className="contacts">
                  <div className="contacts-contact flex flex-col md:gap-[1.5rem] gap-[1.1rem] justify-center mt-[4.5rem] text-[1.5rem] font-[600]">
...
Best%20regards,%20[Your%20Name]"
                          ...
                          <span className="hover:text-[var(--background-color)] duration-300 md:text-[1.5rem] text-[1rem]">Muhammed.hsn@outlook.com</span>
                      </a>
                  </div>
              </div>
              <ContactEmail />
