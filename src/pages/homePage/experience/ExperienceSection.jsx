...
export default function ExperienceSection({ }) {
  ...
  return (
      <div className="experience-Section flex flex-col md:justify-center md:items-center justify-center items-start md:mt-[5rem] mt-[1rem]">
          ...
          <div className="experience-details-container grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:gap-x-[21.2rem] xl:gap-y-[1.2rem] md:gap-x-[10.2rem] md:gap-y-[.1rem] gap-x-[5rem] gap-y-[1.5rem] ">
              {experiencesData.map((item) => (
                  <div className="experience-details flex lg:flex-row md:flex-col flex-col justify-start  md:justify-start lg:items-center md:items-center items-start lg:gap-[1.5rem] md:gap-[.2rem] gap-[.1rem] w-full">
