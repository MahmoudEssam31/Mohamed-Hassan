...
export default function ExperienceSection({ }) {
  ...
  return (
      <div className="experience-Section flex flex-col lg:justify-center w-full lg:items-start md:justify-center md:items-center justify-center items-start md:mt-[5rem] mt-[1rem]">
          ...
          <div className="experience-details-container grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 xl:gap-x-[2.2rem] xl:gap-y-[1.2rem] md:gap-x-[1.2rem] md:gap-y-[1rem] gap-x-[5rem] gap-y-[1.5rem]">
