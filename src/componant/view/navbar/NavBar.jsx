        ...
        <div className="navbar-container  bg-[#096A61] lg:py-[2.5rem] py-[1.2rem]">
            <CustomContainer className="relative">
                <div className="navbar text-white flex justify-between items-center ">
                    ...
                    <div
                        className={`nav-menu absolute lg:right-75 lg:top-10 xl:right-102 xl:top-10 md:right-0 md:top-10  right-0 z-50  top-15  bg-[#096A61] lg:flex duration-500 ${
                            isOpen ? "flex" : "hidden"
                        } lg:flex items-center`}>
                        <ul className={` flex justify-center text-[#ffffffcc]  items-center text-[.95rem] font-[600]  md:gap-[3rem] lg:flex-row md:flex-col flex-col lg:gap-[5rem] `}>
