...
export default  function MyLastesProCard({ id, img, title, name }) {
    return (
        <div className="my-lastest-proj-card relative  flex xl:w-[38.65rem] xl:h-[39.5rem] lg:w-[30.56rem] lg:h-[31.5rem] md:w-[20.31rem] md:h-[26.56rem] w-[90%] h-[26.56rem] overflow-hidden group rounded-[2rem] duration-500 ease-in justify-center items-center ">
