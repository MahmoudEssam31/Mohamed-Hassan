...
export default  function MyLastesProCard({ id, img, title, name, className, imgClass }) {
    return (
        <div
            className={`my-lastest-proj-card relative  flex 2xl:w-[53.65rem] 2xl:h-[54.5rem] xl:w-[35.8rem] xl:h-[36.8rem] lg:w-[28.56rem] lg:h-[29.5rem] md:w-[20.31rem] md:h-[26.56rem] w-[100%] h-[26.56rem] overflow-hidden group rounded-[2rem] duration-500 ease-in justify-center items-center  ${className}`}>
