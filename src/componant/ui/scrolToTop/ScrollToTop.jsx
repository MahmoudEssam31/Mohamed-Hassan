...
export default function ScrollToTop() {
    ...
    return (
        <button
            ...
            className={`fixed right-1 bottom-24 z-50 p-3 rounded-4xl 2xl:w-[4.5rem] 2xl:h-[5rem] lg:w-[3rem] lg:h-[3.5rem] md:w-[2.5rem] md:h-[2.5rem] hidden md:flex bg-[var(--bblue-color)] shadow-lg border
