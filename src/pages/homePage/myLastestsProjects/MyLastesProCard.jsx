...
export default  function MyLastesProCard({ id, img, title, name, className, imgClass }) {
    return (
        <div
            className={clsx(
                `my-lastest-proj-card relative flex xl:w-[33.8rem] xl:h-[39.8rem] lg:w-[31.7rem] lg:h-[33.5rem] xl:px-2 lg:px-4.5 md:px-4.5 md:w-[24.31rem] md:h-[26.56rem] w-[100%] h-[26.56rem] overflow-hidden group hover:rounded-[2rem] duration-500 ease-in justify-center items-center, ${className} `,
            )}>
            ...
            />{" "}
            <div className="my-lastest-proj-text flex flex-col gap-[1rem] absolute bottom-[4rem] left-[1.5rem] text-[var(--main-color)]">
