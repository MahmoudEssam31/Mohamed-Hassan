...
export default function SkillsCards({title, percentage,icon, iconType, img}) {
    return (
        <div className="skills_cards my-[3rem]  grid md:grid-cols-3 grid-cols-1 justify-center items-center">
            <div className="experience-cards-container flex justify-start items-center flex-col gap-[1rem] md:w-[9em]  h-[18em] border-[.09rem] border-[#E6F0EE] hover:border-[var(--background-color)] rounded-4xl hover:translate-y-[-1em] hover:bg-[var(--background-color)] hover:shadow-xl shadow-[#000000] duration-500 group">
