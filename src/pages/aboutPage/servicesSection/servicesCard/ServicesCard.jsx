...
export default function ServicesCard({ id, idNum, name, description, icon, bgg }) {
    return (
        <div className="services relative  ">
            <div className="services-card relative group  flex flex-col gap-[1rem] max-w-[42rex] h-auto min-h-[26.5rem] bg-[#ffffff] rounded-2xl px-[2rem] py-[5.3rem] border-[.3rem] border-[#E6F0EE] transform hover:translate-y-[-1em] duration-500 hover:bg-black overflow-x-hidden hover:border-[var(--dark-color)]">
